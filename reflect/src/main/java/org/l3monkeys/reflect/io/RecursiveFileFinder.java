package org.l3monkeys.reflect.io;
...
public class RecursiveFileFinder {
     ...
     * @return the number of <tt>File</tt> objects found
     */
    public int findFiles (File directory, FilenameFilter filter, Collection<File> collection) {
        int    total = 0;
     ...
     * @return the number of <tt>File</tt> objects found
     */
    public int findFiles (File directory, FileFilter filter, Collection<File> collection) {
        int    total = 0;
        File[] files = directory.listFiles (filter);
