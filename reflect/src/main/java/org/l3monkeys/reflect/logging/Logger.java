...
public class Logger {
    ...
    public boolean isDebugEnabled() {
        return (realLogger == null) ? false : realLogger.isDebugEnabled();
    }
    ...
    public boolean isErrorEnabled() {
        return (realLogger == null) ? false : realLogger.isErrorEnabled();
    }
    ...
    public boolean isFatalEnabled() {
        return (realLogger == null) ? false : realLogger.isFatalEnabled();
    }
    ...
    public boolean isInfoEnabled() {
        return (realLogger == null) ? false : realLogger.isInfoEnabled();
    }
    ...
    public boolean isTraceEnabled() {
        return (realLogger == null) ? false : realLogger.isTraceEnabled();
    }
    ...
    public boolean isWarningEnabled() {
        return (realLogger == null) ? false : realLogger.isWarnEnabled();
    }
