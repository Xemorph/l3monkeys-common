...
import org.l3monkeys.reflect.misc.NestedException;

/**
 * Thrown to indicate that an object already exists when it was expected not to
 * exist.
 */
public class ClassUtilException extends NestedException {
     ...
     */
    public ClassUtilException (String bundleName, String messageKey, String defaultMsg) {
